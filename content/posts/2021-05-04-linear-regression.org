...
* Least Mean Square (LMS) Algorithm
  ...
  calculation, we must [[https://en.wikipedia.org/wiki/Vectorization][vectorize]] the entire operation. I will show this in
...
*** Coding
    ...
    #+BEGIN_EXPORT html
    <img src="/images/posts/linear_regression/initial.png">
    #+END_EXPORT
...
**** Gradient Descent
     ...
     numpy array. Also, you need to augment the ==X== variable with a column of ==1== to make the number
     of columns of ==X== same as that of the number of rows of ==theta==. Here is a gradient
     descent function for linear regression in python using ==numpy== library.
     #+BEGIN_SRC python
       import numpy as np
       ...
       def gradient_descent(X, Y, theta, learning_rate, num_iters):
           ...
           for i in range(num_iters):
               ...
               return theta
     #+END_SRC
     Here is the result from gradient descent:
     #+BEGIN_EXPORT html
     <img src="/images/posts/linear_regression/gradient.png">
     #+END_EXPORT
...
**** Normal Equations
     ...
     #+END_SRC
     This predictor is what normal equations yield on our data.
     #+BEGIN_EXPORT html
     <img src="/images/posts/linear_regression/normal_eqn.png">
     #+END_EXPORT

     As you can see both algorithms perform equally good. It is because our data set is small and gradient descent
     reaches the minimum value quickly. And I've used sufficient number of iterations (> 3000) for our purpose.
     If we'd used less number of iterations we may have gotten less accurate model.
