...
even exists?" while even the experts don't understand the intuition
behind simple formula like Euler's formula, and settle for the
explanation provided by hairy equations like Taylor's expansion.
...
![Complex Number
Addition](/images/posts/complex_numbers/gifs/addition.gif) *Additon of
complex numbers is just like adding two vectors*
...
number](/images/posts/complex_numbers/gifs/magnitude.gif) *Magnitude
of Complex Number*
...
![Exponential
Motion](/images/posts/complex_numbers/gifs/exponential_motion.gif)
...
![Circular
Motion](/images/posts/complex_numbers/gifs/circular_motion.gif)
...
Case](/images/posts/complex_numbers/gifs/euler_general.gif) *General
